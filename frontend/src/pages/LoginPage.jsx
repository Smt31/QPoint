      ...
      >
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-rose-50 via-pink-50 to-white relative p-8 items-center justify-center">
          ...
          >
            ...
            <div className="absolute bottom-8 left-0 right-0 text-center">
              <h1 className="text-3xl font-black bg-gradient-to-br from-rose-500 via-rose-600 to-pink-700 bg-clip-text text-transparent mb-2">Qnect</h1>
        ...
        <div className="flex-1 p-8 md:p-12 flex flex-col justify-center">
          ...
          <div className="md:hidden text-center mb-6">
            <Logo className="justify-center" size={56} fontSize="text-2xl" />
          </div>

          {/* Header */}
          <div className="text-center mb-10">
            <h2 className="text-3xl font-black tracking-tight text-gray-900 mb-2 font-['Outfit']">
              Welcome back to <span className="bg-gradient-to-br from-rose-500 via-rose-600 to-pink-700 bg-clip-text text-transparent">Qnect</span>
            </h2>
            <p className="text-gray-500 text-sm font-medium">Ask questions. Share knowledge. Learn together.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <input
                type="email"
                className="w-full pl-12 pr-4 py-3.5 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-rose-500/10 focus:border-rose-400 focus:bg-white transition-all placeholder-gray-400 text-gray-900 font-medium"
                placeholder="Email"
                value={email}
            ...
            <div>
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3.5 bg-gray-50/50 border border-gray-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-rose-500/10 focus:border-rose-400 focus:bg-white transition-all placeholder-gray-400 text-gray-900 font-medium"
