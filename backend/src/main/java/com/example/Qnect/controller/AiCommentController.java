...
import com.example.Qnect.service.GeminiService;
...
public class AiCommentController {
    ...
    private final com.example.Qnect.service.UserService userService;

    public AiCommentController(GeminiService geminiService, CommentService commentService,
                               PostRepository postRepository, com.example.Qnect.service.UserService userService) {
