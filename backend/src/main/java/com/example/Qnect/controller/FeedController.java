...
public class FeedController {
    ...
    public ResponseEntity<FeedResponseDto> getFeed(
        ...
        try {
            ...
            com.example.Qnect.dto.CursorPageDto<FeedPostDto> feedPosts =
    ...
    @GetMapping("/trending")
    public ResponseEntity<com.example.Qnect.dto.PageDto<FeedPostDto>> getTrending(
            Authentication authentication,
        ...
        return ResponseEntity.ok(new com.example.Qnect.dto.PageDto<>(trendingPosts));
    }
