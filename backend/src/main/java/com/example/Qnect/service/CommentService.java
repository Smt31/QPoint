...
import com.example.Qnect.models.AnswerRequest;
import com.example.Qnect.repository.AnswerRequestRepository;
import com.example.Qnect.repository.CommentRepository;
...
public class CommentService {
    ...
    public com.example.Qnect.dto.PageDto<PostCommentDto> getCommentsStructure(Long postId, int page, int size) {
        Post post = postRepository.findById(postId)
                .orElseThrow(() -> new RuntimeException("Post not found"));
        ...
        return new com.example.Qnect.dto.PageDto<>(convertToPostCommentDtoBulk(comments, null));
    }

    @Transactional(readOnly = true)
    public com.example.Qnect.dto.PageDto<PostCommentDto> getCommentsForPost(Long postId, int page, int size, Long currentUserId) {
        // 1. Get cached structure (votes are NONE)
        com.example.Qnect.dto.PageDto<PostCommentDto> pageDto = getCommentsStructure(postId, page, size);
    ...
    private void populateVotesForPage(com.example.Qnect.dto.PageDto<PostCommentDto> pageDto, Long currentUserId) {
        ...
        java.util.List<com.example.Qnect.models.Vote> votes = voteRepository.findAllByUserAndEntityTypeAndEntityIdIn(
                user, com.example.Qnect.models.Vote.EntityType.COMMENT, allCommentIds);
    ...
    @Transactional(readOnly = true)
    public com.example.Qnect.dto.PageDto<PostCommentDto> getUserComments(Long userId, int page, int size, Long currentUserId) {
        ...
        return new com.example.Qnect.dto.PageDto<>(convertToPostCommentDtoBulk(comments, currentUserId));
    }
