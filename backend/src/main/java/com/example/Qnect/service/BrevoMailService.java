...
public class BrevoMailService {
    ...
    public BrevoMailService(
            ...
            @Value("${brevo.from.name:Qnect}") String fromName) {
    ...
    public void sendOtpEmail(String to, String code) throws Exception {
        ...
        email.setSubject("Your Qnect OTP Code");
        ...
        return String.format("""
                ...
                <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
                    <div style="background: linear-gradient(135deg, #667eea 0%%, #764ba2 100%%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                        <h1 style="color: white; margin: 0; font-size: 28px;">Qnect</h1>
                    </div>
                    ...
                    <div style="text-align: center; margin-top: 20px; color: #999; font-size: 12px;">
                        <p>&copy; 2026 Qnect. All rights reserved.</p>
                    </div>
                </body>
                </html>
                """, code);
