...
public class FileStorageService {
    ...
    private String extractPublicId(String imageUrl) {
        // Example URL:
        // https://res.cloudinary.com/demo/image/upload/v1570979139/Qnect/sample.jpg
        try {
            int QnectIndex = imageUrl.indexOf("Qnect/");
            if (QnectIndex != -1) {
                int dotIndex = imageUrl.lastIndexOf('.');
                if (dotIndex > QnectIndex) {
                    return imageUrl.substring(QnectIndex, dotIndex);
                }
            }
        } catch (Exception e) {
     ...
     * Example: https://res.cloudinary.com/demo/image/upload/v123/Qnect/abc123.jpg
     * Returns: Qnect/abc123
     */
