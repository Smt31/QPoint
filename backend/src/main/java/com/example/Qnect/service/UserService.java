...
import com.example.Qnect.controller.UserController.UpdateProfileRequest;
import com.example.Qnect.dto.UserProfileDto;
import com.example.Qnect.dto.UserStatsDto;
import com.example.Qnect.dto.SuggestionsDto;
import com.example.Qnect.models.User;
import com.example.Qnect.models.Follow;
import com.example.Qnect.repository.UserRepository;
import com.example.Qnect.repository.FollowRepository;
...
import com.example.Qnect.models.Notification;
...
public class UserService {
    ...
    private final com.example.Qnect.repository.PostRepository postRepository;
    ...
    public UserService(UserRepository userRepository, FollowRepository followRepository,
            ...
            com.example.Qnect.repository.PostRepository postRepository, FileStorageService fileStorageService) {
     ...
     * System users have emails ending with @Qnect.system
     */
    private boolean isSystemUser(User user) {
        return user.getEmail() != null && user.getEmail().endsWith("@Qnect.system");
    }
    ...
    public void followUser(Long followerId, Long followingId) {
        ...
        com.example.Qnect.models.Follow follow = new com.example.Qnect.models.Follow();
    ...
    public void updateTopics(Long userId, List<String> topicNames) {
        ...
        if (topicNames != null && !topicNames.isEmpty()) {
            List<com.example.Qnect.models.Topic> existingTopics = topicRepository.findByNameIn(topicNames);
            topics.addAll(existingTopics);

            // Create missing topics
            List<String> existingNames = existingTopics.stream().map(com.example.Qnect.models.Topic::getName)
                    .collect(Collectors.toList());
    ...
    public void followTopic(Long userId, Long topicId) {
        User user = userRepository.findById(userId)
                .orElseThrow(() -> new RuntimeException("User not found"));
        com.example.Qnect.models.Topic topic = topicRepository.findById(topicId)
    ...
    public void unfollowTopic(Long userId, Long topicId) {
        ...
        java.util.Set<com.example.Qnect.models.Topic> topics = user.getTopics();
        if (topics != null) {
    ...
    // AI User Constants
    public static final String AI_USER_EMAIL = "cue@Qnect.system";
