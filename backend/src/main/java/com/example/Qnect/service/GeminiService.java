...
public class GeminiService {
    ...
    private String buildPrompt(String title, String content) {
        ...
        sb.append("You are Cue, a helpful AI assistant answering questions on a Q&A platform called Qnect. ");
    ...
    private String buildRefinePrompt(String title, String description) {
        StringBuilder sb = new StringBuilder();
        sb.append("You are Cue, a writing assistant on Qnect, a Q&A platform. ");
    ...
    private String buildContextAwarePrompt(Post post, List<Comment> comments, String userQuery) {
        StringBuilder sb = new StringBuilder();
        sb.append("You are Cue, a helpful and intelligent AI assistant on Qnect. ");
